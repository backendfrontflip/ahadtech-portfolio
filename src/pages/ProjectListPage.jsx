      ...
      <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <li>
          <a href="https://backendfrontflip.github.io/spacecadetio/advice-generator-app-main/index.html" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/advice-generator.jpg"} alt="Advice Generator" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/spacecadetio/contact-form/contactform.html" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/contact-form.jpg"} alt="Contact Form" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/spacecadetio/news-homepage/newshome.html" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/news-homepage.jpg"} alt="News Hompage" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/spacecadetio/mortgage-calculator/mortgagecalc.html" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/mortgage-calculator.jpg"} alt="Mortgage Calculator" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/expense-chart/" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/expense-chart.jpg"} alt="Expense Chart" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/space-tourism-website/" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/space-tourism.jpg"} alt="Space Tourism" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/conference-ticket-generator-app/" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/conference-ticket.jpg"} alt="Conference Ticket Generator" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/e-commerce-app/" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/e-commerce.jpg"} alt="E-commerce Website" className="w-full h-32 object-cover rounded-lg shadow-lg" />
        ...
        <li>
          <a href="https://backendfrontflip.github.io/sign-up-form/" className="block text-center">
            <img src={import.meta.env.BASE_URL + "public/images/sign-up.jpg"} alt="Sign Up Form" className="w-full h-32 object-cover rounded-lg shadow-lg" />
